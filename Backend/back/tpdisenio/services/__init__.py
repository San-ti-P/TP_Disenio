...
SQL_reserva_DAO = SQLReservaDAO(SQL_actividad_DAO, SQL_reservacion_DAO)
...
gestor_bedel = GestorBedel(gestor_usuario, gestor_contrasenia, SQL_bedel_DAO)
...
gestor_reservacion = GestorReservacion(SQL_reservacion_DAO)
gestor_reserva = GestorReserva(gestor_reservacion, gestor_actividad, gestor_periodo, gestor_aula, gestor_bedel, SQL_reserva_DAO)
